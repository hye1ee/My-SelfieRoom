...
export const HeadTitle = [
  "MY SELFIEROOM",
  "take📷, enjoy🧁, and share📱\nat your own photobooth",
  "Please be aware that this project requires the use of a camera,\nbut the data is only stored within the user's environment."
]